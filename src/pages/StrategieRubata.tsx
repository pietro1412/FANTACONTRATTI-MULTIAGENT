              ...
              <div className="md:hidden space-y-3 p-3">
                {filteredPlayers.map(player => {
                  ...
                  return (
                    <div
                      key={player.playerId}
                      className={`bg-surface-300/30 rounded-lg p-3 border ${
                        hasStrategy ? 'border-indigo-500/30 bg-indigo-500/5' : 'border-surface-50/10'
                      }`}
                    >
                      {/* Player Header */}
                      ...
                      <div className="grid grid-cols-4 gap-2 text-center text-xs mb-3">
                        <div className="bg-surface-300/50 rounded p-1.5">
                          <div className="text-gray-500 text-[10px] uppercase">Contr.</div>
                          <div className="text-accent-400 font-medium">{player.contractSalary}×{player.contractDuration}</div>
                        </div>
                        <div className="bg-surface-300/50 rounded p-1.5">
                        ...
                        <div className="bg-indigo-500/20 rounded p-1.5">
                          <div className="text-indigo-300 text-[10px] uppercase">Max</div>
                          <div className="text-indigo-400 font-bold">{local.maxBid || '-'}M</div>
                        </div>
                      </div>
                      ...
                      <div className="bg-indigo-500/10 rounded-lg p-2 border border-indigo-500/20">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <div className="flex items-center gap-1">
                            <button
                              ...
                              className="w-7 h-7 rounded bg-surface-300/70 text-gray-400 hover:text-white text-sm font-bold"
                            >−</button>
                            <input
                              type="number"
                              value={local.maxBid}
                              ...
                              placeholder="-"
                              className={`w-14 px-1 py-1 bg-surface-300/50 border rounded text-white text-center text-sm font-medium ${
                            ...
                            {[1, 2, 3, 4, 5].map(star => (
                              <button
                                ...
                                className={`w-6 h-6 text-base ${
                                  local.priority >= star ? 'text-purple-400' : 'text-gray-600'
                                }`}
                              >★</button>
                            ))}
                          </div>
                        ...
                        <input
                          ...
                          placeholder="Note..."
                          className={`w-full px-2 py-1.5 bg-surface-300/50 border rounded text-white text-sm ${
                            isSaving ? 'border-blue-500/50' : local.isDirty ? 'border-yellow-500/50' : 'border-surface-50/30'
                          }`}
                        />
                      </div>
