  ...
  const commands = useMemo<CommandItem[]>(() => {
    ...
    if (leagueId) {
      items.push(
        ...
        { id: 'stats', label: 'Statistiche Giocatori', category: 'Lega', icon: '📊', action: () => { void navigate(`/leagues/${leagueId}/rose?view=stats`) }, keywords: 'stats gol assist rating' },
        { id: 'players', label: 'Tutti i Giocatori', category: 'Lega', icon: '⚽', action: () => { void navigate(`/leagues/${leagueId}/rose?view=players`) }, keywords: 'calciatori ricerca' },
        { id: 'history', label: 'Storico', category: 'Lega', icon: '📚', action: () => { void navigate(`/leagues/${leagueId}/history`) }, keywords: 'cronologia passato storico movimenti operazioni' },
