...
const defaultHookReturn = {
  ...
  activityFeed: [] as unknown[],
  preferencesMap: new Map() as Map<string, unknown>,
  selectedPlayerForPrefs: null as unknown,
  openPrefsModal: vi.fn(),
  closePrefsModal: vi.fn(),
  handleSavePreference: vi.fn(),
  handleDeletePreference: vi.fn(),
  handleBulkSetPreference: vi.fn(),
  handleImportPreferences: vi.fn(),
  searchQuery: '',
  ...
  minQuotation: '',
  setMinQuotation: vi.fn(),
  maxQuotation: '',
  setMaxQuotation: vi.fn(),
